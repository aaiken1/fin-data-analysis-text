...
# 
# Our textbook really doesn't have much on factor models, though you'll see the basics of this material, as well as regression more generally, in the DataCamp assignments.
# 
# 
# ## Textbook Highlights
# 
# | Topic         | Pages  |
# | :-------------------------------------------------------------------------------------- | :--------- | 
# | **Linear OLS Regression**. Estimating factor models usually means running some type of regression. Our textbook shows regression using `sklearn`.          | 497 - 499      | 
# | **Market Efficiency**. There's a brief discussion of **random walks** and market efficiency. | 491 - 494    | 
# 
# 
...
# 
# ```{figure} ../images/09-asset-gfc.png
# ---
# name: 09-asset-gfc.png
# align: center
# ---
...
# 
# 
# ```{figure} ../images/09-beta-return.png
# ---
# name: 09-beta-return.png
# align: center
# ---
...
# 
# ```{figure} ../images/09-macro-risk.png
# ---
# name: 09-macro-risk.png
# align: center
# ---
# Different returns and risk (volatility) across different macroeconomic environments. Source: Andrew Ang
# ```
# 
# {numref}`09-macro-risk.png` shows the performance of different equity portfolios, based on firm size, and fixed income portfolios do during different macroeconomic environments. First, note that small stocks beat large stocks over the full sample -- more on this below. Overall, stocks do better in economic expansions than bonds, as you probably expected.
# 
...
# 
# 
# ```{figure} ../images/09-sell-vol.png
# ---
# name: 09-sell-vol.png
# align: center
# ---
...
# 
# 
# ```{figure} ../images/09-factor-perf.png
# ---
# name: 09-factor-perf.png
# align: center
# ---
...
# 
# 
# ```{figure} ../images/09-value-tangibles.png
# ---
# name: 09-value-tangibles.png
# align: center
# ---
...
# 
# ```{figure} ../images/09-sources-of-returns.png
# ---
# name: 09-sources-of-returns.png
# align: center
# ---
...
# 
# 
# ```{figure} ../images/09-buffett-info.png
# ---
# name: 09-buffett-info.png
# align: center
# ---
...
# 
# ```{figure} ../images/09-buffett-alpha.png
# ---
# name: 09-buffett-alpha.png
# align: center
# ---
