...
# 
# `pip` is a way to install Python packages via the command line. But, where is it installing the packages? Which version of Python will it be associated with?
# 
...
# 
# A bit of an aside: There's also another version of Python that doesn't get listed there, because I looked for Python, and not Python3. I can see it when I do **select Kernel** in VS Code. There's a Python 2.x and a Python 3.x that are in my `/usr/bin/` folder. These are the version of Python that came with my Mac. I want to use the latest Anaconda version and not these. So, I want all of my packages to be associated with the Anaconda version. 
# 
...
# ```
# 
# This `pip` method should work for any non-Anaconda package.
# 
# 
